...
docker tag -f $DOCKER_REGISTRY_USER/$REPO-php:git-commit-$COMMITSHA tutum.co/$TUTUM_USER/$REPO-php:git-commit-$COMMITSHA
docker tag -f $DOCKER_REGISTRY_USER/$REPO-nginx:git-commit-$COMMITSHA tutum.co/$TUTUM_USER/$REPO-nginx:git-commit-$COMMITSHA
